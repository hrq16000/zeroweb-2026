...
export const CENTRO_MEGA_DEMO_PRODUCTS: CentroMegaDemoProduct[] = [
  {
    ...
    description:
      "Smartphone apresentado em publicação pública indexada da Centro Mega. Na amostra, o item funciona como produto real de referência da vitrine digital.",
  ...
  },
  {
    ...
    description:
      "Modelo de tênis divulgado em publicação pública indexada da marca. As postagens espelhadas mostram numerações diferentes, por isso a amostra pede confirmação da grade atual.",
    badge: "Post social verificado",
    sourceType: "PUBLIC_SOCIAL_POST",
    sourceLabel: "Publicação pública indexada da Centro Mega",
    sourceUrl:
  ...
  },
  {
    ...
    description:
      "Categoria incluída a partir do mix informado pelo responsável da 0WEB para demonstrar como a Centro Mega pode vender novidades de giro rápido.",
  ...
  },
  {
    ...
    category: "Acessórios",
    eyebrow: "Linha oficial da presença atual",
    description:
      "Categoria coerente com a presença digital já publicada da Centro Mega, preparada para receber capinhas, carregadores, fones, películas e outros itens quando confirmados.",
    badge: "Categoria oficial",
    sourceType: "OFFICIAL_STORE_CONTEXT",
    sourceLabel: "Presença atual Centro Mega + loja/canais oficiais",
    detail: "Produtos específicos entram apenas quando houver postagem, catálogo ou evidência atual",
    availabilityNote: "Amostra funcional; itens e preços específicos devem ser confirmados.",
    visual: "accessory",
    accent: "blue",
  },
  {
    id: "achadinhos-outlet",
    name: "Achadinhos da semana",
    category: "Outlet",
    eyebrow: "Coleção dinâmica da amostra",
    description:
      "Espaço editorial para transformar postagens rápidas do Facebook e Instagram em uma vitrine organizada de oportunidades.",
    badge: "Feed → vitrine",
    sourceType: "OWNER_SUPPLIED_ASSORTMENT",
    sourceLabel: "Estratégia de loja virtual solicitada para a Centro Mega",
    detail: "Ideal para produtos de estoque curto, ponta de grade e novidades sociais",
