...
export const CENTRO_MEGA_DEMO_PRODUCTS: CentroMegaDemoProduct[] = [
  ...
  },
  {
    ...
    availabilityNote: "Categoria funcional; itens e preços específicos devem ser confirmados.",
    visual: "accessory",
    accent: "blue",
  },
  {
