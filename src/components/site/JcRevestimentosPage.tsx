...
const services = [
  ...
  {
    icon: BrickWall,
    title: "Grafiato e textura lisa",
    text: "Opções de textura para diferentes propostas de acabamento.",
  },
  {
    icon: Building2,
    title: "Massas para preparo",
    text: "Massa corrida, acrílica e niveladora para preparar superfícies.",
  },
  {
    icon: Droplets,
    title: "Linha de revestimentos",
    text: "Materiais de revestimento direto da fábrica para sua obra.",
  },
];
    ...
    <div className="min-h-dvh bg-background text-foreground" style={theme}>
      <header className="border-b border-border bg-card/95 px-5 backdrop-blur">
        <div className="mx-auto flex min-h-20 max-w-6xl items-center justify-between gap-4">
          <a href="#inicio" aria-label="JC Revestimentos — início">
            <PortfolioImage
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <h2 className="max-w-2xl font-display text-3xl font-bold md:text-5xl">
                Da preparação da parede ao acabamento que valoriza o ambiente.
              </h2>
              <p className="max-w-md text-sm leading-6 text-muted-foreground">
                Conheça a linha de revestimentos e escolha a solução para o seu projeto.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl font-bold md:text-4xl">
                Conte o ambiente e encontre o revestimento ideal.
              </h2>
              <ol className="mt-8 space-y-5">
                {[
                  "Escolha o tipo de textura ou massa que procura.",
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-background/70">
              Revestimentos e materiais para pintura.
            </p>
          </div>
          <PortfolioHostCredit
