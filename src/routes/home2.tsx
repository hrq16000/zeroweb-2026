...
const solutions = [
  {
    ...
    description:
      "Páginas pensadas para explicar valor com clareza, carregar rápido e transformar atenção em próximo passo.",
  ...
  },
  {
    ...
    description: "Estrutura para a empresa ser encontrada quando a procura já existe.",
  ...
  },
  {
    ...
    description: "Campanhas conectadas a páginas, mensuração e uma jornada coerente de conversão.",
  ...
  },
  {
    ...
    description:
      "Não tratamos site, tráfego e automação como ilhas. A arquitetura começa no objetivo e termina na ação que importa.",
    to: "/solucoes",
    icon: Target,
      ...
      <MotionScope intensity="BALANCED">
        <main>
          <section className="relative isolate min-h-[92svh] overflow-hidden border-b border-border pt-32 sm:pt-36 lg:flex lg:min-h-screen lg:items-end lg:pt-40">
            <div
              className="pointer-events-none absolute -right-40 top-16 h-[34rem] w-[34rem] rounded-full bg-primary/10 blur-3xl"
              aria-hidden="true"
            />
            <div
              className="pointer-events-none absolute bottom-0 left-[45%] h-px w-[55%] bg-gradient-to-r from-primary/70 to-transparent"
              aria-hidden="true"
            />
            ...
            <div className="relative mx-auto w-full max-w-[1480px] px-5 pb-16 sm:px-8 sm:pb-20 lg:px-12 lg:pb-16">
              <MotionReveal variant="mask" intensity="EXPRESSIVE">
                ...
                <h1 className="max-w-[1280px] font-display text-[clamp(3.7rem,9.5vw,9.5rem)] font-bold leading-[0.86] tracking-[-0.07em]">
                  Presença digital
                  <span className="block text-primary">com direção.</span>
                </h1>
              </MotionReveal>
              ...
              <div className="mt-10 grid gap-10 border-t border-border pt-7 lg:grid-cols-12 lg:items-end">
                <MotionReveal variant="left" intensity="BALANCED" className="lg:col-span-5">
                  <p className="max-w-xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
                    Sites, campanhas, presença local e automações organizados em uma experiência que
                    leva o cliente da descoberta até a ação.
                  </p>
                </MotionReveal>
                ...
                <MotionReveal variant="right" intensity="SUBTLE" className="lg:col-span-7 lg:flex lg:justify-end">
                  <div className="flex flex-col gap-3 sm:flex-row">
                    <FunnelCTAButton
                      ...
                      location="home2_hero"
                      className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-foreground px-6 py-3.5 font-semibold text-background transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary motion-reduce:transform-none"
                    />
                    <Link
                      to="/portfolio"
                      className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-border px-6 py-3.5 font-semibold transition-colors hover:border-primary hover:text-primary"
                    >
                      Ver projetos
          ...
          <section className="py-24 sm:py-28 lg:py-36" aria-labelledby="home2-manifesto">
            <div className="mx-auto grid max-w-[1480px] gap-14 px-5 sm:px-8 lg:grid-cols-12 lg:px-12">
              ...
              <MotionReveal variant="mask" intensity="BALANCED" className="lg:col-span-8">
                <h2
                  id="home2-manifesto"
                  className="font-display text-4xl font-bold leading-[0.98] tracking-[-0.045em] sm:text-6xl lg:text-7xl"
                >
                ...
                <div className="mt-10 grid gap-8 border-t border-border pt-8 sm:grid-cols-2">
                  <p className="leading-relaxed text-muted-foreground">
                    Uma boa experiência digital precisa explicar rapidamente quem você é, o que resolve e qual é o próximo passo.
                  </p>
                  <p className="leading-relaxed text-muted-foreground">
                    A 0WEB une estrutura, conteúdo, tecnologia, aquisição e conversão sem transformar o site em um catálogo de efeitos desconectados.
                  </p>
                </div>
              </MotionReveal>
            </div>
            ...
            <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-12">
              <div className="grid gap-8 border-b border-background/20 pb-10 lg:grid-cols-12 lg:items-end">
                <MotionReveal variant="left" className="lg:col-span-8">
                  ...
                  <h2 id="home2-solutions" className="mt-4 font-display text-4xl font-bold tracking-[-0.045em] sm:text-6xl lg:text-7xl">
                    Uma estrutura para cada objetivo.
                  </h2>
                </MotionReveal>
                ...
                {solutions.map((solution, index) => {
                  ...
                  return (
                    <MotionReveal
                      ...
                      intensity={index === 0 ? "BALANCED" : "SUBTLE"}
                      className={solution.className}
                    >
                      <Link
                        to={solution.to}
                        className="group flex h-full min-h-[280px] flex-col justify-between border border-background/15 bg-background/[0.035] p-7 transition-colors hover:border-primary/70 hover:bg-background/[0.07] sm:p-9 lg:min-h-[320px]"
                      >
            ...
            <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-12">
              <div className="grid gap-12 lg:grid-cols-12">
                <MotionReveal variant="left" className="lg:col-span-7">
                  ...
                  <h2 id="home2-proof" className="mt-4 max-w-4xl font-display text-4xl font-bold tracking-[-0.045em] sm:text-6xl lg:text-7xl">
                    O portfólio é a prova, não o enfeite.
                  </h2>
                </MotionReveal>

                <MotionReveal variant="right" className="lg:col-span-5 lg:pt-14">
                  <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">
                    Cada projeto publicado tem identidade própria, conteúdo e fluxo compatíveis com o negócio atendido. A vitrine existe para ser navegada, não para sustentar números sem evidência.
                  </p>
                </MotionReveal>
              </div>
              ...
              <div className="mt-16 grid border-y border-border sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="border-b border-border py-8 sm:pl-8 lg:border-b-0 lg:border-r lg:px-8">
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary">Arquitetura</p>
                  <p className="mt-3 text-xl font-semibold">Funil por projeto</p>
                </div>
                <div className="border-b border-border py-8 sm:border-b-0 sm:border-r lg:px-8">
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary">Descoberta</p>
                  <p className="mt-3 text-xl font-semibold">SEO e rotas próprias</p>
                </div>
                <div className="py-8 sm:pl-8 lg:pl-8">
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-primary">Experiência</p>
                  <p className="mt-3 text-xl font-semibold">Mobile, acessível e mensurável</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-12">
              <div className="flex flex-col gap-8 border-b border-border pb-10 lg:flex-row lg:items-end lg:justify-between">
                <MotionReveal variant="mask">
                  ...
                  <h2 id="home2-projects" className="mt-4 font-display text-4xl font-bold tracking-[-0.045em] sm:text-6xl lg:text-7xl">
                    Trabalhos que você pode abrir agora.
                  </h2>
                </MotionReveal>
                    ...
                    <Link to="/portfolio/$slug" params={{ slug: item.slug }} className="group block">
                      <div className="overflow-hidden border border-border bg-card">
                        <PortfolioCover
                          ...
                          className="aspect-[16/10] w-full object-cover transition-transform duration-700 group-hover:scale-[1.025] motion-reduce:transform-none"
                        />
                      </div>
          ...
          <section className="py-24 sm:py-28 lg:py-36" aria-labelledby="home2-trust">
            <div className="mx-auto grid max-w-[1480px] gap-14 px-5 sm:px-8 lg:grid-cols-12 lg:px-12">
              <MotionReveal variant="left" className="lg:col-span-5">
                ...
                <h2 id="home2-trust" className="mt-4 font-display text-4xl font-bold tracking-[-0.045em] sm:text-5xl">
                  Mostramos o que existe. Medimos o que acontece.
                </h2>
              </MotionReveal>
              ...
              <MotionReveal variant="right" className="lg:col-span-7">
                <div className="grid gap-0 border-y border-border sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={title}
                      className={`py-7 sm:p-7 ${index % 2 === 0 ? "sm:border-r" : ""} ${index < 2 ? "border-b border-border" : ""}`}
                    >
          ...
          <section className="border-y border-border bg-foreground py-24 text-background sm:py-28 lg:py-36" aria-labelledby="home2-editorial">
            <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-12">
              <MotionReveal variant="mask">
                ...
                <h2 id="home2-editorial" className="mt-4 max-w-5xl font-display text-4xl font-bold tracking-[-0.045em] sm:text-6xl lg:text-7xl">
                  A presença digital também precisa ensinar.
                </h2>
              </MotionReveal>

              <div className="mt-14 border-t border-background/20">
                {editorialLinks.map((item, index) => (
                  <MotionReveal key={item.title} variant={index % 2 === 0 ? "left" : "right"} intensity="SUBTLE">
                    <Link
                      to={item.to}
                      className="group grid gap-5 border-b border-background/20 py-8 sm:grid-cols-[140px_1fr_auto] sm:items-center"
                    >
                      <span className="text-xs font-bold uppercase tracking-[0.18em] text-primary">{item.label}</span>
                      <span className="font-display text-2xl font-semibold tracking-[-0.025em] sm:text-3xl">{item.title}</span>
          ...
          <section className="py-24 sm:py-28 lg:py-36" aria-labelledby="home2-final-cta">
            <div className="mx-auto max-w-[1480px] px-5 sm:px-8 lg:px-12">
              <MotionReveal variant="scale" intensity="EXPRESSIVE">
                <div className="relative overflow-hidden border border-border bg-primary px-6 py-12 text-primary-foreground sm:px-10 sm:py-16 lg:px-14 lg:py-20">
                  <div className="grid gap-12 lg:grid-cols-12 lg:items-end">
                    <div className="lg:col-span-8">
                      <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary-foreground/70">Próximo passo</p>
                      <h2 id="home2-final-cta" className="mt-4 font-display text-4xl font-bold leading-[0.94] tracking-[-0.05em] sm:text-6xl lg:text-7xl">
                        Tem uma ideia? Vamos dar direção a ela.
                      </h2>
                    </div>
                    <div className="lg:col-span-4 lg:flex lg:justify-end">
                      <FunnelCTAButton
                        ...
                        className="inline-flex min-h-12 items-center justify-center rounded-full bg-background px-6 py-3.5 font-semibold text-foreground transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-background motion-reduce:transform-none"
                      />
                    </div>
                  </div>
                </div>
