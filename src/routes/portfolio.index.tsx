              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
                ...
                <select
                  ...
                  onChange={(e) => setRegion(e.target.value)}
                    className="h-12 min-w-48 rounded-xl border border-border bg-background px-4 text-sm text-foreground outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
                >
                ...
                <select
                  ...
                  onChange={(e) => setSort(e.target.value)}
                    className="h-12 rounded-xl border border-border bg-background px-4 text-sm text-foreground outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
                >
