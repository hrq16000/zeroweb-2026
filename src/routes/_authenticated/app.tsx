...
const ADMIN_NAV: NavItem[] = [
  ...
  { to: "/app/portfolio/whatsapp", icon: Phone, label: "WhatsApp por portfólio" },
  { to: "/app/portfolio/protocolos", icon: ClipboardList, label: "Protocolos por portfólio" },
  { to: "/app/portfolio/leads", icon: Users, label: "Leads por portfólio" },
