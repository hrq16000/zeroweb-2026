...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "article:section", content: "Home · Serviços · Portfólio · Processo" },
              ...
              itemListElement: [
                {
                  "@type": "ListItem",
                  position: 1,
                  name: "Serviços e soluções digitais",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <MotionScope intensity="BALANCED">
        <main>
          {on("hero") ? (
            <MotionChoreo surface="root-editorial" role="hero">
              <HomeHeroV2 />
            </MotionChoreo>
          ) : null}
          ...
          {on("projetos_no_ar") ? (
            <MotionChoreo surface="root-editorial" role="showcase">
              <Suspense key="projects-v2" fallback={<Skel />}>
                <ProjetosNoAr />
              </Suspense>
            </MotionChoreo>
          ) : null}
