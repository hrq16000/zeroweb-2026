...
export const PORTFOLIO_PROTOTYPES: readonly PortfolioPrototype[] = [
  {
    ...
    siteName: "Autoescola APTOS — carro e moto automáticos em São José dos Pinhais",
    kind: "prototype",
    indexable: true,
  },
  ...
  { slug: "pastelaria-route-66", vertical: "restaurantes", siteName: "Pastelaria e Lanchonete Route 66", kind: "prototype", indexable: true },
  ...
  },
  {
    slug: "bruna-diarista",
    vertical: "prestadores-de-servicos",
    siteName: "Bruna Diarista · Curitiba — PR",
    kind: "prototype",
    indexable: true,
  },
  {
  ...
  },
  {
    slug: "easy-clean",
    vertical: "prestadores-de-servicos",
    siteName: "Easy Clean Higienização a Seco · Curitiba — PR",
    kind: "prototype",
    indexable: true,
  },
  {
