...
export const PORTFOLIO_CLIENT_KEYS = [
  "lucas-arruma-maquina-lavar","lk-alvenaria","vila-da-capivara","ag-electrical-services","refrigeracao-maresia","studio-de-cilios","mp-festas-eventos","confeitaria-chyrley",
  "dyzpromo",
  "renata-beauty",
  "r-beauty",
  "marido-de-aluguel",
