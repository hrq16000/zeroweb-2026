...
export const PORTFOLIO_CLIENT_KEYS = [
  "fernanda-amaral-drywall","manu-pasteis","lj-cleaning","galileu-locacao-brinquedos","miro-tech","premium-envelopamentos","angel-mix-brecho","brecho-sao-francisco","reuse-house-brecho","toquinho-de-gente-brecho","dlara-pizzaria","woodhouse-hamburgueres","beto-pasteis","marmitaria-dom-diego","sos-presentes-cosmeticos",
  ...
  "rm-fretes",
  "rj-servicos-drywall",
  "lolipa-arte-em-festas","confeitaria-sabor-da-realeza","liz-moraes-nail-designer","assistencia-microondas-santos","artesanatos-darleia-oliveira","thays-camilla",
] as const;
