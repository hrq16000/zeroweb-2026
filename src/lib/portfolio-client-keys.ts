...
export const PORTFOLIO_CLIENT_KEYS = [
  "galileu-locacao-brinquedos","miro-tech","premium-envelopamentos","angel-mix-brecho","brecho-sao-francisco","reuse-house-brecho","toquinho-de-gente-brecho","dlara-pizzaria","woodhouse-hamburgueres","beto-pasteis","marmitaria-dom-diego","sos-presentes-cosmeticos",
