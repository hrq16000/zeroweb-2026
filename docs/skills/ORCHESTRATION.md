...
classificar tarefa
   ...
   -> selecionar capacidades da PORTFOLIO_CAPABILITY_PALETTE
...
| Motion | `docs/design/MOTION.md` → palette de motion → gramática de motion do cliente → checagem `prefers-reduced-motion` |
...
e `docs/PORTFOLIO_CAPABILITY_PALETTE.md`. A direção precisa definir topologia,
