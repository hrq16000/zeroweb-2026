...
- **Cobertura:** 25 referências nomeadas registradas em ledger próprio; 23 presenças oficiais atuais acessíveis, 1 revalidação parcial (UNIFACIG) e Ext Trade Tech mantida como `REFERENCE_ONLY` por ausência de resolução oficial atual segura.
