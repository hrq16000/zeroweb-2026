...
| Corpus multi-source / seleção USE-ADAPT-REJECT / clusters de decisão / motion evidence | `docs/research/PORTFOLIO_REFERENCE_CORPUS_R1_2026-09-23.md` · `src/config/portfolio-reference-pattern-library.json` · `docs/PORTFOLIO_CREATIVE_DIRECTION_STANDARD.md` §4.5 |
| Corpus R2 automotivo / configurador, check-up, laudo, calculadora, agendamento e transparência processual | `docs/research/PORTFOLIO_REFERENCE_CORPUS_R2_AUTOMOTIVE_2026-09-23.md` · `docs/PORTFOLIO_CREATIVE_DIRECTION_STANDARD.md` §4.6 · `docs/PORTFOLIO_CAPABILITY_PALETTE.md` §9.2 |
...
`docs/PORTFOLIO_LANDING_RESEARCH_INTELLIGENCE_STANDARD.md` e execute
