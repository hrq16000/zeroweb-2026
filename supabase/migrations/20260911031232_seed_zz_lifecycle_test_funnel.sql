-- Funil individual de ZZ Lifecycle Test (funnel-zz-lifecycle-test).
...
values ('funnel-zz-lifecycle-test', 'ZZ Lifecycle Test', 'draft', 'Funil individual de ZZ Lifecycle Test')
