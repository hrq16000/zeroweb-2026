-- Funil individual de Brechó São Francisco (funnel-brecho-sao-francisco).
...
values ('funnel-brecho-sao-francisco', 'Brechó São Francisco', 'published', 'Funil individual de Brechó São Francisco')
