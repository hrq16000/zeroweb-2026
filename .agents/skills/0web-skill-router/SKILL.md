...
- avaliar a motion matrix global (`fade-up`, `fade-left`, `fade-right`, `blur-in`, `scale-in`, `stagger-up`, `image-reveal`, `clip-reveal`, `parallax`, `marquee`, `float`, `header-scroll`, `menu-reveal`), aplicando o máximo pertinente;
...
Referências externas e visuais são repertório, não template. WCRIA, Doğukan Tavlacı, Suprema Mídia, Apple HIG e skills de frontend/UI podem orientar ritmo, craft e interação, mas nunca autorizam copiar marca, assets, números, depoimentos ou claims.
